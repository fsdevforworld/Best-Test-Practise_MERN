...
import { run, getAdvances } from '../../src/crons/collect-payback-date-blind-withdrawal';
...
describe('collect-payback-date-blind-withdrawal', () => {
  ...
  it('excludes advances not due today', async () => {
    const debitCard = await factory.create('payment-method', {
      invalid: null,
      invalidReasonCode: null,
      deleted: null,
